...
//                            SignupActivity cameraFragment = new SignupActivity();
...
//                        return false;
                        if (drawerItem instanceof Nameable) {
                            toolbar.setTitle(((Nameable) drawerItem).getName().getText(CrossfadeDrawerLayoutActvitiy.this));
...
//                        }
    ...
    private void setupViewPager(ViewPager viewPager) {
        CrossfadeDrawerLayoutActvitiy.ViewPagerAdapter adapter = new CrossfadeDrawerLayoutActvitiy.ViewPagerAdapter(getSupportFragmentManager());
...
// this method create delete button in toolbar
   ...
   public boolean onCreateActionMode(ActionMode mode, Menu menu) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                getWindow().setStatusBarColor(UIUtils.getThemeColorFromAttrOrRes(CrossfadeDrawerLayoutActvitiy.this, R.attr.colorPrimaryDark, R.color.material_drawer_primary_dark));
            }
